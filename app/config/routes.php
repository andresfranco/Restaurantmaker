...
$router->addResource('MenuTranslation', '/menu_translation');
$router->addResource('Dish', '/dish');
$router->addResource('DishCategory', '/dish_category');
$router->addResource('CategoryTranslation', '/category_translation');
...
$router->addResource('EventTranslation', '/event_translation');
$router->addResource('Test', '/test');
return $router;
