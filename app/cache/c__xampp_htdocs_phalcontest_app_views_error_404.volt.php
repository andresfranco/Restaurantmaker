...
<link href="<?php echo $this->url->getStatic('metronic/assets/admin/pages/css/error.css'); ?>" rel="stylesheet" type="text/css"/>
...
<link href="<?php echo $this->url->getStatic('css/animate/animate.css'); ?>" rel="stylesheet" type="text/css"/>
...
<div class="row">
	<div class="col-md-12 page-404">
            <h2><b>LA PÁGINA SOLICITADA NO SE ENCUENTRA</b></h2><p class="number animated zoomInDown"><b>404</b></p>
                <br><br>
		<div>
                    <?php echo $this->tag->image(array('img/lostface.png', 'id' => 'ogo', 'class' => 'animated flip')); ?>
		</div>
		
               <div class="details animated flip">
                   <h2><b>
				
				Por favor<a href="<?php echo $this->url->get('login'); ?>">
