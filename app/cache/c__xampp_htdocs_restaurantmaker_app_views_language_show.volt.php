...
code:'<?php echo $this->getDI()->get("translate")->_('language.code.required'); ?>'
,language:'<?php echo $this->getDI()->get("translate")->_('language.required'); ?>'
};
</script>
