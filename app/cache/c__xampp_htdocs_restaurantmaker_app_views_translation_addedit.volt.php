...
<div class="portlet box blue">
	...
	<?php foreach ($formcolumns as $index => $item) { ?>
		...
		<label name="<?php echo $this->getDI()->get("translate")->_($item['name']); ?>" id ="item['name']" class="control-label col-md-3 formlabel">
...
key:'<?php echo $this->getDI()->get("translate")->_('translation.required.key'); ?>'
,value:'<?php echo $this->getDI()->get("translate")->_('translation.required.value'); ?>'
};
</script>
