...
<div class="col-sm-12 col-md-2 col-xs-12 col-lg-2 accordion_menu">
  ...
  <?php } ?>
    ...
    <?= $this->tag->linkTo([$view_gallery_route . $entity->id, '<i class="fa fa-photo fa-lg"></i>', 'class' => 'btn btn-icon-only yellow']) ?>

    </td>
    <td width ="2%">

    <?= $this->tag->linkTo([$uploadroute . $entity->id, '<i class="fa fa-cloud-upload fa-lg"></i>', 'class' => 'btn btn-icon-only blue']) ?>
