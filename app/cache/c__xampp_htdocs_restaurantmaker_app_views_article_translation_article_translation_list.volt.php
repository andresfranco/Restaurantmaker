...
<div class="col-sm-12 col-md-2 col-xs-12 col-lg-2 accordion_menu">
  ...
  <div class="main_content">
   ...
   <h3 class="page-title" align ="left"><?php echo $this->getDI()->get("translate")->_($title); ?> (<?php echo $article_name; ?>)</h3><div align="right"><a href ="<?php echo $this->url->get('article/list'); ?>" class="btn btn blue"><?php echo $this->getDI()->get("translate")->_('Articles'); ?> <i class="fa fa-arrow-right "></i> </a></div>
	<hr/>
  <!-- GRID SEARCH -->
	<div align="left" >
	<?php echo $this->tag->form(array($searchroute . '/' . $articleid, 'method' => 'post', 'autocomplete' => 'off')); ?>
	<div class="row">
  ...
  <!-- END GRID SEARCH-->
	...
	<?php if ($permissions['create'] == 'Y') { ?>
	 <!-- NEW ITEM ICON-->
	<div align="left"><?php echo $this->tag->linkTo(array($newroute . '/' . $articleid, '<i class="fa fa-plus fa-lg"></i>')); ?></div>
  <?php } ?>
	<br>
	<?php if ($noitems == '') { ?>
	...
	<?php if (isset($page->items)) { ?>
		<?php foreach ($page->items as $entity) { ?>
			...
			<td width ="2%">
				...
				<?php echo $this->tag->linkTo(array($editroute . $entity->id . '/' . $articleid, '<i class="fa fa-edit fa-lg"></i>', 'class' => 'btn btn-icon-only green')); ?>
				<?php } ?>
			</td>
			<td width ="2%">
	...
	<!--END GRID BODY -->
		...
		<div align ="left">
		<ul class="pagination">
		<li><?php echo $this->tag->linkTo(array($listroute . '/' . $articleid, '<i class="fa fa-angle-left"></i><i class="fa fa-angle-left"></i>')); ?></li>
		<li><?php echo $this->tag->linkTo(array($listroute . '/' . $articleid . '?page=' . $page->before, '<i class="fa fa-angle-left"></i>')); ?></li>
		...
		<?php $classitem = ''; ?>
		<?php } ?>
		<li class="<?php echo $classitem; ?>"><?php echo $this->tag->linkTo(array($listroute . '/' . $articleid . '?page=' . $i, $i)); ?></li>
		<?php } ?>
		<li><?php echo $this->tag->linkTo(array($listroute . '/' . $articleid . '?page=' . $page->next, '<i class="fa fa-angle-right"></i>')); ?></li>
		<li><?php echo $this->tag->linkTo(array($listroute . '/' . $articleid . '?page=' . $page->last, '<i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i>')); ?></li>
		</ul>
		</div>
    <!--END GRID PAGINATION -->
	<?php } else { ?>
