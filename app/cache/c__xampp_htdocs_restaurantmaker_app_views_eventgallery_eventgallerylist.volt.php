...
<div class="col-sm-12 col-md-2 col-xs-12 col-lg-2 accordion_menu">
  ...
  <div class="main_content">
   ...
   <h3 class="page-title" align ="left"><?php echo $this->getDI()->get("translate")->_($title); ?> (<?php echo $event_name; ?>)</h3>
   <div align="right"><a href ="<?php echo $this->url->get('event/list'); ?>" class="btn btn blue"><?php echo $this->getDI()->get("translate")->_('Events'); ?> <i class="fa fa-arrow-right "></i> </a></div>
	<hr/>
  <!-- GRID SEARCH -->
	<div align="left" >
	<?php echo $this->tag->form(array($searchroute . '/' . $eventid, 'method' => 'post', 'autocomplete' => 'off')); ?>
	<div class="row">
  ...
  <!-- END GRID SEARCH-->
	...
	<?php if ($permissions['create'] == 'Y') { ?>
	 <!-- NEW ITEM ICON-->
	<div align="left"><?php echo $this->tag->linkTo(array($newroute . '/' . $eventid, '<i class="fa fa-plus fa-lg"></i>')); ?></div>
  <?php } ?>
	<br>
	<?php if ($noitems == '') { ?>
	...
	<td width ="2%">
		...
		<?php echo $this->tag->linkTo(array($showroute . $eventid . '/' . $entity->galleryid, '<i class="fa fa-remove fa-lg"></i>', 'class' => 'btn btn-icon-only red')); ?>
		<?php } ?>
	</td>
	</tr>
	<?php } ?>
	...
	<!--END GRID BODY -->
		...
		<div align ="left">
		<ul class="pagination">
		<li><?php echo $this->tag->linkTo(array($listroute . '/' . $eventid, '<i class="fa fa-angle-left"></i><i class="fa fa-angle-left"></i>')); ?></li>
		<li><?php echo $this->tag->linkTo(array($listroute . '/' . $eventid . '?page=' . $page->before, '<i class="fa fa-angle-left"></i>')); ?></li>
		...
		<?php } ?>
		<li><?php echo $this->tag->linkTo(array($listroute . '/' . $eventid . '?page=' . $page->next, '<i class="fa fa-angle-right"></i>')); ?></li>
		<li><?php echo $this->tag->linkTo(array($listroute . '/' . $eventid . '?page=' . $page->last, '<i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i>')); ?></li>
		</ul>
		</div>
    <!--END GRID PAGINATION -->
	<?php } else { ?>
