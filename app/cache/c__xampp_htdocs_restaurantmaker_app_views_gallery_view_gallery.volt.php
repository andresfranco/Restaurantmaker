...
<div class="col-sm-12 col-md-2 col-xs-12 col-lg-2 accordion_menu">
  ...
  <div class="main_content">
    ...
    <div class="row mix-grid">
      ...
      <?php echo $this->getDI()->get("translate")->_($gallery_data['title']); ?><div align="right"><a href ="<?php echo $this->url->get('gallery/list'); ?>" class="btn btn blue"><?php echo $this->getDI()->get("translate")->_('Galleries'); ?> <i class="fa fa-arrow-right "></i> </a></div>
    </h3>
    <hr/>
    <?php foreach ($gallery_images as $file) { ?>
    <div style="display: block;  opacity: 1;" class="col-lg-1 col-md-1 col-sm-2 col-xs-3">
      <div class="mix-inner">
      <img height="50" width="50"src="<?php echo $this->url->getStatic('files/galleries/' . $gallery_data['name'] . '_gallery/' . $file['name']); ?>" alt="">
      <div class="mix-details">
      
        <a class="mix-link" data-toggle="modal" data-id="<?php echo $file['imageid']; ?>" href="#basic">
          <i class="fa fa-remove fa-lg"></i>
        </a>
        <a  id ="single_1" class="zoom" href="<?php echo $this->url->getStatic('files/galleries/' . $gallery_data['name'] . '_gallery/' . $file['name']); ?>"  data-rel="fancybox-button">
     ...
     <div class="modal-dialog">
      <div class="modal-content">
       <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo '¿ Esta seguro que desea borrar este archivo ?'; ?></h4>
       </div>
       <div class="modal-footer">
   			<input id="filename" type="hidden" name="filename" data-name ="<?php echo $gallery_data['id']; ?>" value="">
        <button id ="deletebutton" type="button" class="btn blue"><?php echo $this->getDI()->get("translate")->_('Eliminar'); ?></button>
        <button type="button" class="btn default" data-dismiss="modal"><?php echo $this->getDI()->get("translate")->_('Cerrar'); ?></button>
...
<script type="text/javascript" src="<?php echo $this->url->getStatic('tools/fancybox//lib/jquery.mousewheel-3.0.6.pack.js'); ?>"></script>
<link rel="stylesheet" type="text/css" href="<?php echo $this->url->getStatic('tools/fancybox/source/jquery.fancybox.css'); ?>" />
<script type="text/javascript" src="<?php echo $this->url->getStatic('tools/fancybox/source/jquery.fancybox.js'); ?>"></script>
<script type="text/javascript" src="<?php echo $this->url->getStatic('tools/fancybox/source/jquery.fancybox.pack.js'); ?>"></script>
<link rel="stylesheet" type="text/css" href="<?php echo $this->url->getStatic('tools/fancybox/source/helpers/jquery.fancybox-buttons.css'); ?>" />
<script type="text/javascript" src="<?php echo $this->url->getStatic('tools/fancybox/source/helpers/jquery.fancybox-buttons.js'); ?>"></script>
<script type="text/javascript" src="<?php echo $this->url->getStatic('tools/fancybox/source/helpers/jquery.fancybox-media.js'); ?>"></script>
<link rel="stylesheet" type="text/css" src="<?php echo $this->url->getStatic('tools/fancybox/source/helpers/jquery.fancybox-thumbs.css'); ?>"/>
<script type="text/javascript" src="<?php echo $this->url->getStatic('tools/fancybox/source/helpers/jquery.fancybox-thumbs.js'); ?>"></script>
<script type="text/javascript" src="<?php echo $this->url->getStatic('js/validate_gallery/delete_image_modal.js'); ?>"></script>
    <!-- Optionally add helpers - button, thumbnail and/or media -->
<script>
 jQuery(document).ready(function(){$(".zoom").fancybox({openEffect : 'elastic',closeEffect : 'elastic',helpers : {title : {type : 'inside'}}}); });
</script>
  
        <?php echo $this->assets->outputJs('delete_modal_js'); ?>
