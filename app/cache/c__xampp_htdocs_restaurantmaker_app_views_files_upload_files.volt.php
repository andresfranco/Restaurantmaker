  ...
  <div class="main_content">
	...
	<!-- BEGIN CONTENT -->
          ...
          <h3 class="page-title" align ="left">
        	<?php echo $this->getDI()->get("translate")->_($title_tags['main_title']); ?>
        	</h3>
        	<hr/>
					<form id="fileupload" action="<?php echo $this->url->get('file/upload_files'); ?>" method="POST" enctype="multipart/form-data">
