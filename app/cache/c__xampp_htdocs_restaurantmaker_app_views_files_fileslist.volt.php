...
<div class="col-sm-12 col-md-2 col-xs-12 col-lg-2 accordion_menu">
  ...
  <?php } ?>
	...
	<?php if ($this->isIncluded('image', $entity->type)) { ?>
	<?php $downloadroute = $download_path . 'images/'; ?>
	<?php } elseif ($this->isIncluded('video', $entity->type)) { ?>
	<?php $downloadroute = $download_path . 'videos/'; ?>
	<?php } elseif ($this->isIncluded($entity->type, $document_types)) { ?>
	<?php $downloadroute = $download_path . 'documents/'; ?>
	<?php } else { ?>
	<?php $downloadroute = $download_path . 'other/'; ?>
	<?php } ?>
	<tr>
	<?php foreach ($headercolumns as $index => $item) { ?>
	<?php if ($item['column_name'] == 'name') { ?>
	<td width ="15%"><a href ="<?php echo $downloadroute . $entity->readAttribute($item['column_name']); ?>"><?php echo $entity->readAttribute($item['column_name']); ?></a></td>
	<?php } elseif ($item['column_name'] == 'size') { ?>
	<td width ="15%"><?php echo $entity->readAttribute($item['column_name']) . ' Mb'; ?></td>
	<?php } else { ?>
