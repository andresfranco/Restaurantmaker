...
<link href="<?php echo $this->url->getStatic('metronic/assets/global/plugins/bootstrap-summernote/summernote.css'); ?>" rel="stylesheet" type="text/css" />
...
<div class="portlet box blue">
	...
	<?php foreach ($formcolumns as $index => $item) { ?>
		...
		<div class="col-md-4">
		<?php echo $form->render($item['name']); ?>
  ...
  <input id ="savebutton" type="submit" class="btn blue-madison" value="<?php echo $this->getDI()->get("translate")->_('Guardar'); ?>"></input>
