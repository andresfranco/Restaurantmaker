...
<div class="row row_container_form">
	...
	<?php } ?>
       ...
       <div class="col-md-offset-1 col-md-3" style="padding-left:0;">
		...
		<?= $this->tag->linkTo([$routelist . '/' . $articleid, $this->getDI()->get("translate")->_($cancel_button_name), 'class' => 'btn btn-default']) ?>
       </div>
    </div>	
	</form>
	<!-- END FORM-->	
...
var validatemessages = {
	title:'<?= $this->getDI()->get("translate")->_('article_translation.title.required') ?>',
	content:'<?= $this->getDI()->get("translate")->_('article_translation.content.required') ?>'
};
</script>
