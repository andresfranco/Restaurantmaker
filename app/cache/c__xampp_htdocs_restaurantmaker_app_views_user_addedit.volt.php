...
<div class="row row_container_form">
	...
	<?php foreach ($formcolumns as $index => $item) { ?>
	  <?php if (($mode == 'edit')) { ?>
     <?php if (!$this->isIncluded($item['name'], array('password', 'confirm_password'))) { ?>
	...
	<?php } else { ?>
      <div class="form-group">
		<label name="<?php echo $item['name']; ?>" id ="item['name']" class="control-label col-md-2 align_label_left">
		<?php echo $this->getDI()->get("translate")->_($item['label']); ?>
		<?php echo $item['required']; ?>
        </label>
		<div class="col-md-4">
	...
	<?php } ?>
	<?php } ?>
       <div class="<?php if (($mode == 'edit')) { ?>col-md-offset-1<?php } else { ?>col-md-offset-2<?php } ?> col-md-3" style="padding-left:0;">
...
username:'<?php echo $this->getDI()->get("translate")->_('username.required'); ?>'
,email_req:'<?php echo $this->getDI()->get("translate")->_('email.required'); ?>'
,email:'<?php echo $this->getDI()->get("translate")->_('email.valid'); ?>'
,pass:'<?php echo $this->getDI()->get("translate")->_('pass.required'); ?>'
,confirm:'<?php echo $this->getDI()->get("translate")->_('confirm.required'); ?>'
,equal:'<?php echo $this->getDI()->get("translate")->_('confirm.equal'); ?>'
};
</script>
