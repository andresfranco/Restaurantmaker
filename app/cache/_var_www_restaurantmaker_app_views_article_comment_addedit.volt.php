...
name:'<?= $this->getDI()->get("translate")->_('article_comment.name.required') ?>',
email:'<?= $this->getDI()->get("translate")->_('article_comment.email.required') ?>',
valid_email:'<?= 'article_comment.email' ?>',
comment:'<?= $this->getDI()->get("translate")->_('article_comment.comment.required') ?>'
};
</script>
