...
<div class="row row_container_form">
	...
	<?php foreach ($formcolumns as $index => $item) { ?>
	  <?php if (($mode == 'edit')) { ?>
     <?php if (!$this->isIncluded($item['name'], ['password', 'confirm_password'])) { ?>
...
username:'<?= $this->getDI()->get("translate")->_('username.required') ?>'
,email_req:'<?= $this->getDI()->get("translate")->_('email.required') ?>'
,email:'<?= $this->getDI()->get("translate")->_('email.valid') ?>'
,pass:'<?= $this->getDI()->get("translate")->_('pass.required') ?>'
,confirm:'<?= $this->getDI()->get("translate")->_('confirm.required') ?>'
,equal:'<?= $this->getDI()->get("translate")->_('confirm.equal') ?>'
};
</script>
