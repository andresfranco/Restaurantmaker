...
code:'<?= $this->getDI()->get("translate")->_('systemparameter.code.required') ?>',
parameter:'<?= $this->getDI()->get("translate")->_('systemparameter.parameter.required') ?>',
textvalue:'<?= $this->getDI()->get("translate")->_('systemparameter.textvalue.required') ?>'
