...
<head>
  ...
  <!-- End Stylesheets --> 
    ...
    <?php echo $this->assets->outputCss('upload_file_css'); ?>
    <script>
    var file_param =new Array();
    file_param['acceptFileTypes'] =<?php echo $file_formats['accept_file_types']; ?> ;
    file_param['maxFileSize'] =<?php echo $upload_params['max_file_size']; ?>;
    file_param['minFileSize'] =<?php echo $upload_params['min_file_size']; ?>;
    file_param['maxNumberOfFiles'] =<?php echo $upload_params['max_number_of_files']; ?>;
    file_param['accept_file_error']='<?php echo $this->getDI()->get("translate")->_('validate.file.validformats'); ?>';
    file_param['max_file_size_error']='<?php echo $this->getDI()->get("translate")->_('validate.file.maxsize'); ?>';
    file_param['min_file_size_error']='<?php echo $this->getDI()->get("translate")->_('validate.file.minsize'); ?>';
    file_param['max_number_files_error']='<?php echo $this->getDI()->get("translate")->_('validate.file.filesnumber'); ?>';
    </script>
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="page-title" align ="left">
                <?php echo $this->getDI()->get("translate")->_($title_tags['main_title']); ?><?php echo ' (' . $gallery_data['title'] . ')'; ?>
            </h3>
            <div align="right"><a href ="<?php echo $this->url->get('gallery/list'); ?>" class="btn btn blue"><?php echo $this->getDI()->get("translate")->_('Galleries'); ?> <i class="fa fa-arrow-right "></i> </a></div>
            <hr/>
            <form id="fileupload" action="<?php echo $this->url->get('gallery/upload_images/' . $galleryid); ?>" method="POST" enctype="multipart/form-data">
...
<!-- javaScripts --> 
  ...
  <script src="<?php echo $this->url->getStatic('tools/bootstrap/js/bootstrap.min.js'); ?>"></script> 
    ...
    <?php echo $this->assets->outputJs('upload_file_javascripts'); ?>
