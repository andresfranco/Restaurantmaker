...
title:'<?php echo $this->getDI()->get("translate")->_('article.title.required'); ?>',
author:'<?php echo $this->getDI()->get("translate")->_('article.author.required'); ?>',
content:'<?php echo $this->getDI()->get("translate")->_('article.content.required'); ?>'
};
</script>
