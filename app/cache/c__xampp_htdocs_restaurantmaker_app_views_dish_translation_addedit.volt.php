...
<div class="row row_container_form">
	...
	<?php } ?>
       <div class="col-md-offset-2 col-md-3" style="padding-left:0;">
		...
		<?php echo $this->tag->linkTo(array($routelist . '/' . $dishid, $this->getDI()->get("translate")->_($cancel_button_name), 'class' => 'btn btn-default')); ?>
       </div>
    </div>   
	<!-- FORM ACTION BUTTONS-->
	</form>
...
var validatemessages = {
	name:'<?php echo $this->getDI()->get("translate")->_('dish_translation.name.required'); ?>',
	description:'<?php echo $this->getDI()->get("translate")->_('dish_translation.description.required'); ?>'
};
</script>
