...
<div class="col-sm-12 col-md-2 col-xs-12 col-lg-2 accordion_menu">
  ...
  <div class="main_content">
   ...
   <h3 class="page-title" align ="left"><?= $this->getDI()->get("translate")->_($title) ?> (<?= $event_name ?>)</h3>
   <div align="right"><a href ="<?= $this->url->get('event/list') ?>" class="btn btn blue"><?= $this->getDI()->get("translate")->_('Events') ?> <i class="fa fa-arrow-right "></i> </a></div>
	<hr/>
  <!-- GRID SEARCH -->
	<div align="left" >
  ...
  <?php } ?>
	...
	<td width ="2%">
		...
		<?= $this->tag->linkTo([$showroute . $eventid . '/' . $entity->galleryid, '<i class="fa fa-remove fa-lg"></i>', 'class' => 'btn btn-icon-only red']) ?>
		<?php } ?>
	</td>
	</tr>
	<?php } ?>
