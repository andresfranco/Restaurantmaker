...
var validatemessages = {
	title:'<?php echo $this->getDI()->get("translate")->_('article_translation.title.required'); ?>',
	content:'<?php echo $this->getDI()->get("translate")->_('article_translation.content.required'); ?>'
};
</script>
