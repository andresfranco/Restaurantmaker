...
<div class="row row_container_form">
	...
	<?php } ?>
       <div class="col-md-offset-2 col-md-3" style="padding-left:0;">
		...
		<?= $this->tag->linkTo([$routelist . '/' . $restaurantId, $this->getDI()->get("translate")->_($cancel_button_name), 'class' => 'btn btn-default']) ?>
       </div>
    </div>   
	<!-- FORM ACTION BUTTONS-->
	</form>
...
var validatemessages = {
	name:'<?= $this->getDI()->get("translate")->_('restaurant_translation.name.required') ?>',
	image_title:'<?= $this->getDI()->get("translate")->_('restaurant_translation.image_title.required') ?>'
};
</script>
