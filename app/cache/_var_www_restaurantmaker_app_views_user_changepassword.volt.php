...
<div class="row row_container_form">
	...
	<!-- LOAD FORM CONTROLS-->
		...
		<label name="passwordlabel" id ="passwordlabel" class="control-label col-md-2 align_label_left"><?= 'Password' ?>
		 ...
		 <div class="col-md-4">
		 <?= $this->tag->passwordField(['password', 'size' => 30, 'class' => 'form-control']) ?>
		...
		<span class="required" aria-required="true">* </span>
		 ...
		 <div class="col-md-4">
		<?= $this->tag->passwordField(['confirm_password', 'size' => 30, 'class' => 'form-control']) ?>
		 <!-- LOAD CONTROL ERROR LABEL-->
		 </div>
		</div>
...
<?= $this->assets->outputJs('change_password') ?>
