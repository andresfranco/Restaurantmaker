...
<div class="col-sm-12 col-md-2 col-xs-12 col-lg-2 accordion_menu">
  ...
  <div class="main_content">
   ...
   <h3 class="page-title" align ="left">
	<?php echo $this->getDI()->get("translate")->_($title); ?><?php echo ' - '; ?><?php echo $dish_name; ?><div align="right"><a href ="<?php echo $this->url->get('dish/list/' . $menu_id); ?>" class="btn btn blue"><?php echo $this->getDI()->get("translate")->_('Dishes'); ?> <i class="fa fa-arrow-right "></i> </a></div>
	</h3>
	<hr/>
  <!-- GRID SEARCH -->
	<div align="left" >
