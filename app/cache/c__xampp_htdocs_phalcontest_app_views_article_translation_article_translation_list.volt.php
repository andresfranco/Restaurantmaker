...
<div class="col-sm-12 col-md-2 col-xs-12 col-lg-2 accordion_menu">
  ...
  <div class="main_content">
   ...
   <h3 class="page-title" align ="left"><?php echo $this->getDI()->get("translate")->_($title); ?></h3><div align="right"><a href ="<?php echo $this->url->get('article/list'); ?>" class="btn btn blue"><?php echo $this->getDI()->get("translate")->_('Articles'); ?> <i class="fa fa-arrow-right "></i> </a></div>
	<hr/>
  <!-- GRID SEARCH -->
	<div align="left" >
