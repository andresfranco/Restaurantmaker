...
var validatemessages = {
	name:'<?= $this->getDI()->get("translate")->_('menu.name.required') ?>',
	title:'<?= $this->getDI()->get("translate")->_('menu.title.required') ?>',
  description:'<?= $this->getDI()->get("translate")->_('menu.description.required') ?>'
};
</script>
