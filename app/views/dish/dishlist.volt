...
{% block content %}
   <h3 class="page-title" align ="left">{{title|t}} ({{restaurant_name~'-'~menu_name}})</h3>
   <div align="right"><a href ="{{url('menu/list')}}" class="btn btn blue">{{'Menus'|t}} <i class="fa fa-arrow-right "></i> </a></div>
	<hr/>
  <!-- GRID SEARCH -->
	<div align="left" >
