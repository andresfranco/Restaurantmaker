...
{% block content %}
  ...
  {% endif %}
    ...
    {{link_to(view_gallery_route~entity.id,'<i class="fa fa-photo fa-lg"></i>','class':'btn btn-icon-only yellow')}}

    </td>
    <td width ="2%">

    {{link_to(uploadroute~entity.id,'<i class="fa fa-cloud-upload fa-lg"></i>','class':'btn btn-icon-only blue')}}
