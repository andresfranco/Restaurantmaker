...
{% block content %}
   <h3 class="page-title" align ="left">{{title|t}} ({{event_name}})</h3>
   <div align="right"><a href ="{{url('event/list' )}}" class="btn btn blue">{{'Events'|t}} <i class="fa fa-arrow-right "></i> </a></div>
	<hr/>
  <!-- GRID SEARCH -->
	<div align="left" >
  ...
  {% endif %}
	...
	<td width ="2%">
		...
		{{link_to(showroute~eventid~'/'~entity.galleryid,'<i class="fa fa-remove fa-lg"></i>','class':'btn btn-icon-only red')}}
		{% endif %}
	</td>
	</tr>
	{% endfor %}
